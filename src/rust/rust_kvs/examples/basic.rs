...
fn type_mismatch_demo(kvs: &Kvs) {
    ...
    kvs.set_value("mismatch_u32", 456_u32).expect("Failed to set u32");
    ...
    kvs.set_value("mismatch_i64", 789_i64).expect("Failed to set i64");
    ...
    kvs.set_value("mismatch_u64", 101112_u64).expect("Failed to set u64");
    ...
    kvs.set_value("mismatch_f64", 3.1415_f64).expect("Failed to set f64");
    ...
    kvs.set_value("mismatch_bool", true).expect("Failed to set bool");
    ...
    kvs.set_value("mismatch_string", "hello world").expect("Failed to set string");
    ...
    kvs.set_value("mismatch_null", ()).expect("Failed to set null");
    ...
    kvs.set_value("mismatch_array", vec![1_i32.into(), 2_i32.into()]).expect("Failed to set array");
    ...
    kvs.set_value("mismatch_object", obj).expect("Failed to set object");
...
fn main() {
   ...
   // kvs.remove_key("my_key").expect("Failed to remove key");
    ...
    kvs.set_value("i32_key", 123_i32).expect("Failed to set i32");
    kvs.set_value("u32_key", 456_u32).expect("Failed to set u32");
    kvs.set_value("i64_key", 789_i64).expect("Failed to set i64");
    kvs.set_value("u64_key", 101112_u64).expect("Failed to set u64");
    kvs.set_value("f64_key", 3.1415_f64).expect("Failed to set f64");
    kvs.set_value("bool_key", true).expect("Failed to set bool");
    kvs.set_value("string_key", "hello world").expect("Failed to set string");
    kvs.set_value("null_key", ()).expect("Failed to set null");
    kvs.set_value("array_key", vec![1_i32.into(), 2_i32.into(), 3_i32.into()]).expect("Failed to set array");
    use std::collections::HashMap;
    let mut obj = HashMap::new();
    obj.insert("field1".to_string(), 1_i32.into());
    obj.insert("field2".to_string(), 2_i32.into());
    kvs.set_value("object_key", obj).expect("Failed to set object");
