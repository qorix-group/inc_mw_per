...
#[test]
fn kvs_new_wo_defaults_builder() -> Result<(), ErrorCode> {
    ...
    if let KvsValue::Object(json_map) = kvs.get_value("object")? {
        ...
        if let KvsValue::Array(json_sub_array) = &json_map["sub-array"] {
